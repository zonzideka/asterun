...
云电脑已有材料复制、摘要校验、固定 a13 wheel 下载、Python 3.13.5 独立 venv 安装与版本读取记录。fake 任务已验证相同请求键复用任务、离开聊天页面后的 cron 唤醒、原聊天交付、claim/ack、末次 poll 返回 `needs_followup=false` 及暂停 routine。真实后端、应用重启恢复和独立接收方继续按[验收记录](https://github.com/zonzideka/asterun/blob/grokbot-template-v0.1.0-rc1/integrations/grokbot/acceptance.md)逐项验证；同账户 Bot 副本保留原账户环境。
