...
The optional [GrokBot template](integrations/grokbot/README.en.md) is undergoing `0.1.0-rc1` acceptance. It tracks ordinary tasks through a separate SQLite ledger and host routines. All 48 template offline tests and 34 core packaging checks pass; core runtime code and existing protocols are unchanged. Cloud installation and a same-chat probe have been verified on the current account. Full task delivery is being checked, and independent new-user acceptance remains pending. See the [template acceptance record](integrations/grokbot/acceptance.md).
